     ...
     <Box  display={"flex"}
       ...
       <Image marginRight="10px" src="src/assets/SIGNAL LOGO (2)@3x.png" alt="Dan Abramov"  height={'100px'}/>
        ...
        <Box ml="50px">
            ...
            <Text fontSize="14px" p="20px">We have some amazing, specially curated reward products related to this task for Shreya in our e-store. Take a look and assign them to Shreya's reward catalogue.</Text>
        </Box>

        <Box>

        <ChakraProvider>
        <Box display="grid" gridTemplateColumns={{base:'repeat(1,1fr)',md:'repeat(2,1fr)',lg:'repeat(4,1fr)'}} gap={20} p={20}>
        ...
        <Box mt={6}>
            ...
            <Text ml="30px"  onClick={handleClick} style={{ color: color }}  borderRadius={'10px'} bg={'white'} textAlign={'center'}>{text}</Text>
        </Box>
        </Flex>
...
export default SelectedRewards